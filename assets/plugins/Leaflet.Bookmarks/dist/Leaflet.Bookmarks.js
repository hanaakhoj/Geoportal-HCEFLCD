...
var Bookmarks = L.Control.extend( /**  @lends Bookmarks.prototype */ {
  ...
  options: {
    ...
    title: 'Géosignets',
    emptyMessage: 'Pas encore de géosignets',
    addBookmarkMessage: 'Ajouter un géosignet',
...
var FormPopup = L.Popup.extend( /** @lends FormPopup.prototype */ {
  ...
  options: {
    ...
    templateOptions: {
      ...
      editMenuText: 'Modifier',
      removeMenuText: 'Supprimer',
      cancelMenuText: 'Annuler',
      submitTextCreate: '+',
    ...
    menuTemplate: '<ul class="nav {{ mode }}" role="menu">' +
      '<li class="{{ editClass }}"><a href="#" class="{{ menuItemClass }}">{{ editMenuText }}</a></li>' +'<br>'+
      '<li class="{{ removeClass }}"><a href="#" class="{{ menuItemClass }}">{{ removeMenuText }}</a></li>' +'<br>'+
      '</ul>'
  },
